    ...
    <section id="cta" className="relative py-24 px-6 md:px-10 text-center bg-gradient-to-br from-navy-mid via-navy to-[#0A2040] border-y border-brand-blue/20 overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto">
        ...
        <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto mb-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <button
            type="submit"
            className="bg-blue-gradient text-white px-7 py-3.5 rounded-lg font-poppins font-bold text-sm whitespace-nowrap hover:opacity-90 hover:-translate-y-0.5 transition-all"
          >
            Join Free →
          </button>
        </form>
